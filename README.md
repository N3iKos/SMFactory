...
| Colab | [![Open in Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/N3iKos/SMFactory/blob/main/notebook/Segsmaker_COLAB.ipynb) |
| :---------------------------------------- | :-----------------------------------------------------------------------------------------------------------------: |
| Kaggle | [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://www.kaggle.com/code/jejejojo/asdasd) |
| SageMaker Studio Lab | ![Status](https://img.shields.io/badge/â˜ ï¸-DEAD-darkred) |
<br>
<p align="center">
